...
from kv_cache_eval.features.technical_research.infinigen.ingest import (
    DEFAULT_DOCUMENT_DIR, Source, file_sha256, load_sources, make_chunks, validate_sources,
)
...
def index_is_current(index_dir: Path, fingerprint: str) -> bool:
    ...
    try:
        ...
        return (
            ...
            and meta["created_by"] == "kv-cache-eval:infinigen"
...
def ensure_index(
    ...
    try:
        ...
        meta = {
            "format": INDEX_FORMAT, "created_by": "kv-cache-eval:infinigen",
